...
"""
from falcon_gen.common import split, merge, q                     # Import split and merge
from falcon_gen.ntt_constants import roots_dict_Zq, inv_mod_q     # Import constants useful for the FFT
